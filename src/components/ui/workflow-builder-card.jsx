...
export const WorkflowBuilderCard = ({
  ...
  return (
    ...
    >
      <Card className="overflow-hidden rounded-xl shadow-md transition-shadow duration-300 hover:shadow-xl border-white/10">
        {/* Card Image */}
          ...
          <div className="flex items-center -space-x-2">
            {actions.map(({ Icon, bgColor }, index) => (
              <div
                key={index}
                className={cn(
                  "flex h-7 w-7 items-center justify-center rounded-full border-2 border-black text-white",
                  bgColor
                )}
              >
                <Icon size={14} />
